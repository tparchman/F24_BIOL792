...
Chapter 8 of Haddock and Dunn does a nice job of walking you through a script that codes and performs various actions on strings and integers (both types of scalar variables). Lets build on that here to cover a few aspects of working with strings and integers in python, including:
